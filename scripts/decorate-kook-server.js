...
const rolePlan = [
  ...
  { env: "KOOK_GAME_NARAKA_BLADEPOINT_ROLE_ID", name: "⚔️ 永劫无间组", color: 0xfacc15, mentionable: true },
  { env: "KOOK_GAME_CALL_OF_DUTY_ROLE_ID", name: "🎧 塔科夫/COD组", color: 0x34d399, mentionable: true },
